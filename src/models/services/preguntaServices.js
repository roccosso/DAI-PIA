...
export default class PreguntasService {
    Insert = async (pregunta, respuesta01, respuesta02, respuesta03,respuesta04, respuestaCorrecta, fechaCreacion) => {
        ...
        console.log("Estoy en : PreguntasService.Insert")
        try {
            ...
            let result = await pool.request()
                ...
                .query("INSERT INTO Pizzas(Pregunta,Respuesta01,Respuesta02,Respuesta03,Respuesta04,RespuestaCorrecta,FechaCreacion) VALUES(@pPregunta, @pRespuesta01, @pRespuesta02, @pRespuesta03, @pRespuesta04, @pRespuestaCorrecta,@pFechaCreacion)")
